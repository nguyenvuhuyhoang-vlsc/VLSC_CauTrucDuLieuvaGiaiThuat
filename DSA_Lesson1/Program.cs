...
namespace Buoi_ThucHanh
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("=== Bài tập 1: Tham chiếu ===");
            ...
            // -> Thao tác, giữ nguyên giá trị mà không cần trả về kết quả
            Console.WriteLine("\n=== Bài tập 2: Hoan doi (swap) ===");
